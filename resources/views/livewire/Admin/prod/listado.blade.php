                    ...
                    @foreach ($prods as $prod)
                        <tr>
                            ...
                            <td>
                                <div class="form-row">
                                    <div class="col-md-auto">
                                        <img src="{{ $prod->vchImg }} " width="50px" height="50px"
                            ...
                            <td>
                                @if ($prod->intIdCat == 1)
                                    Caballero
                                @elseif($prod->intIdCat==2)
                                    Dama
                                @elseif($prod->intIdCat==3)
                                    Niño
                                @elseif($prod->intIdCat==4)
                                    Unisex
                            ...
                            <td>
                                <button type="button" class="btn btn-primary"
                                    wire:click="mostrarupdprod({{ $prod->intIDProd }})">
                                    <i class="far fa-edit"></i>
                                </button>

                                <button type="button" class="btn btn-danger"
                                    wire:click="mostrarEliminar({{ $prod->intIDProd }})">
